import { config, orderdetail, authToken } from '../../src/config/mongoConfig';
...
afterAll(async () => {
    await dropCollections("orderdetails");
    await dbDisconnect();
});
